...
import clip
from ms_clip.clip import _MODELS, _download
...
def pytorch_params(pth_file):
    ...
    par_dict = clip_model.state_dict()
    pt_params = []
...
def main(args):
    ...
    if os.path.exists(args.pth_path):
        ...
        # model_path = _download(_MODELS[args.pth_path],"./ms_clip")
        pt_param = pytorch_params(args.pth_path)
        ms.save_checkpoint(pt_param, "./ms_clip/ms_clip_model.ckpt")
    else:
        raise ValueError(
